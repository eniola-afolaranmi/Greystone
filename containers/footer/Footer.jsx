...
const Footer = () => {
  return (
    <div
      className="cn__footer section__padding"
      id="contact"
    >
      ...
      <div className="cn__footer-links">
        ...
        <div className="cn__footer-links_socialmedia">
          ...
          <div className="cn__footer-links_socialmedia-icons">
            <a
              href="https://www.instagram.com/CodeNinjasWestshore/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <IconBrandInstagram
            ...
            <a
              href="https://www.facebook.com/CodeNinjasWestshore"
              target="_blank"
              rel="noopener noreferrer"
            >
              <IconBrandFacebook
